...
const LadakhRegions = () => {
  ...
  const filteredData = trekData.filter((data)=> data.region === "Ladakh")
  return (
    <div className="section-package-gallery-lists">
      ...
      <div className="grid-container">
        ...
        <Link href="/trekking-in-ladakh" className="mx-4 px-10 py-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white font-semibold rounded-full shadow-lg hover:shadow-xl transition-all">Explore More</Link>
        <div className="line"></div>
      </div>
