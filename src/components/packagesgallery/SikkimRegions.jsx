...
const SikkimRegions = () => {
  ...
  const filteredData = trekData.filter((data) => data.region === "Sikkim");
  return (
  ...
  <Link href="/trekking-in-sikkim" className="mx-4 px-10 py-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white font-semibold rounded-full shadow-lg hover:shadow-xl transition-all">Explore More</Link>
  <div className="line"></div>
</div>
