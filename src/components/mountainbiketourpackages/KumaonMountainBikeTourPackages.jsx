...
const KumaonMountainBikeTourPackages = () => {
   const filteredData = activities.filter((data) => data.region === "Kumaon"  && data.activity === "Mountain-Biking");
  return (
...
export default KumaonMountainBikeTourPackages