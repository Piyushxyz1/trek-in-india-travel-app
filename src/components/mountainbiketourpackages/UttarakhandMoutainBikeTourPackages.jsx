...
const UttarakhandMoutainBikeTourPackages = () => {
   const filteredData = activities.filter((data) => data.region === "Uttarakhand"  && data.activity === "Mountain-Biking");
  return (
...
export default UttarakhandMoutainBikeTourPackages