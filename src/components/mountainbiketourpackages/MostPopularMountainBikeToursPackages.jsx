...
const MostPopularMountainBikeToursPackages = () => {


   const filteredData = activities.filter((data) => data.isPopular && data.activity === "Mountain-Biking");
  return (
...
export default MostPopularMountainBikeToursPackages