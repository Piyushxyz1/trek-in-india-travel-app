...
const GarhwalMountainBikeTourPackages = () => {
   const filteredData = activities.filter((data) => data.region === "Garhwal"  && data.activity === "Mountain-Biking");
  return (
...
export default GarhwalMountainBikeTourPackages