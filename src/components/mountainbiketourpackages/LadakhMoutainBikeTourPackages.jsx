...
const LadakhMoutainBikeTourPackages = () => {
   const filteredData = activities.filter((data) => data.region === "Ladakh"  && data.activity === "Mountain-Biking");
  return (
...
export default LadakhMoutainBikeTourPackages