...
const HimachalMountainBikeTourPackages = () => {
   const filteredData = activities.filter((data) => data.region === "Himachal"  && data.activity === "Mountain-Biking");
  return (
...
export default HimachalMountainBikeTourPackages