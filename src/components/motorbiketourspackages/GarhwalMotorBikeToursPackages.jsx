...
const GarhwalMotorBikeToursPackages = () => {
   const filteredData = activities.filter((data) => data.region === "Garhwal"  && data.activity === "Motor-Biking");
  return (
...
export default GarhwalMotorBikeToursPackages