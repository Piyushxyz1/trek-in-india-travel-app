...
const LadakhMotorBikeToursPackages = () => {
    
   const filteredData = activities.filter((data) => data.region === "Ladakh" && data.activity === "Motor-Biking");
  return (
...
export default LadakhMotorBikeToursPackages