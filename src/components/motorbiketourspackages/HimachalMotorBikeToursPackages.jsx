...
const HimachalMotorBikeToursPackages = () => {
   const filteredData = activities.filter((data) => data.region === "Himachal" && data.activity === "Motor-Biking");
  return (
...
export default HimachalMotorBikeToursPackages