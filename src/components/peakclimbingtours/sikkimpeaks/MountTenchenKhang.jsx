...
const MountTenchenKhang = () => {
    const [isOpen, setIsOpen] = useState(false);
    const openModal = () => setIsOpen(true);
    const closeModal = () => setIsOpen(false);
    const [currentSlide, setCurrentSlide] = useState(0);

    const peakclimbingsikkim = activities.filter((activity)=>activity.activity === "Peak-Climbing" && activity.region === "Sikkim")
    ...
    return (
        ...
        <>
            ...
            <section className="destinations-page__section py-8 px-4 sm:px-6 lg:px-8 my-5 sm:my-10 md:my-30 xl:my-34 ">
                <div className=' max-w-4xl md:max-w-6xl  xl:max-w-7xl  mx-auto px-4 md:px-8 '>
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div className="lg:w-2/3">
                            ...
                            <h1 className="text-xl sm:text-2xl  xl:text-4xl font-semibold text-[#172541] mt-0 mb-0 md:mb-2 lg:mb-3">MountTenchenKhang </h1>
                ...
                <ClimbingTourSlider TrekData={peakclimbingsikkim} />
...
export default MountTenchenKhang;