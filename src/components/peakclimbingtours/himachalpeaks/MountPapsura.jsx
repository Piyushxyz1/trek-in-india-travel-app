                ...
                <div className=' max-w-4xl md:max-w-6xl  xl:max-w-7xl  mx-auto px-4 md:px-8 '>
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div className="lg:w-2/3">
                            ...
                            <h1 className="text-xl sm:text-2xl  xl:text-4xl font-semibold text-[#172541] mt-0 mb-0 md:mb-3 lg:mb-4">Mount Papsura Expedition, Himachal </h1>
                            ...
                            <h2 className="text-xl sm:text-2xl  xl:text-3xl text-[#f47a2a] mb-6 mt-6">Highlights of Mount Papsura Expedition  </h2>

                            {/* Ladakh Section */}
                            <div className="mb-8 bg-white">
                                <ul>
                                    <li className=' text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb-2'> <span className="text-[#f47a2a] text-xl mr-2">•</span>The Base Camp serves as the launch point for twin summit expeditions - Mount Papsura (6,451 m) and Dharamsura (6,446 m), both towering over the remote Tosh Valley in Himachal Pradesh.

                                    </li>
                                    <li className='text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb-2'> <span className="text-[#f47a2a] text-xl mr-2">•</span>Mount Papsura, the highest peak in the region, is renowned for being one of the most technically demanding climbs in the Pir Panjal Range.</li>

                                    <li className='text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb-2'> <span className="text-[#f47a2a] text-xl mr-2">•</span>Climbing Papsura is a true test of endurance, technical prowess, and mental fortitude, attracting only the most seasoned mountaineers.
                                    </li>
                                    <li className='text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb-2'> <span className="text-[#f47a2a] text-xl mr-2">•</span>The peak’s extremely difficult terrain, remoteness and harsh climatic conditions mean that few have attempted and succeeded in scaling this elusive Himalayan giant.
                                    </li>
                                </ul>
                            ...
                            {/* Best Time Section */}
                            <div className="mb-8">
                                <h2 className="text-xl sm:text-2xl  xl:text-3xl text-[#f47a2a] mb-6 mt-6">Fitness Requirements for Mount Papsura Expedition </h2>
                                ...
                                <ul>
                                    ...
                                    <li className='text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb-2'> <span className="text-[#f47a2a] text-xl mr-2">•</span><b>Basic Climbing Skills:</b>Knowledge of using technical equipment like ropes, crampons, harnesses, and ice axes is essential. Experience with glacier travel and fixed rope ascents is highly recommended.</li>

                                    <li className='text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb-2'> <span className="text-[#f47a2a] text-xl mr-2">•</span><b>Strong Heart and Lung Fitness:</b> Climbing above 6000 meters involves very low oxygen levels. Good cardiovascular health is necessary to manage continuous movement on steep and icy gradients. </li>


                                    <li className='text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb-2'> <span className="text-[#f47a2a] text-xl mr-2">•</span><b>Solid Strength and Core Fitness:</b>Carrying 15 to 20 kg backpacks across moraines, snowfields, and ridgelines demands strong legs, shoulders, and core stability for safe movement.

                                    </li>
                                    <li className='text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb-2'> <span className="text-[#f47a2a] text-xl mr-2">•</span><b>Cold and Weather Tolerance: </b>The route often faces high wind speeds, snowfall, and freezing temperatures. Climbers must be able to function effectively in harsh, cold conditions for extended periods.</li>
                                    <li className='text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb-2'> <span className="text-[#f47a2a] text-xl mr-2">•</span><b>Altitude Acclimatization:</b> Previous exposure to elevations above 5000 meters helps the body adapt to the thin air at Papsura’s summit height of 6451 meters, reducing the risk of AMS. </li>
                                    <li className='text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb-2'> <span className="text-[#f47a2a] text-xl mr-2">•</span><b>Overall Good Health: </b> Climbers must be free from any chronic heart, lung, or joint issues. A pre-expedition medical fitness certificate is advised for safety assurance. </li>
                                    <li className='text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb-2'> <span className="text-[#f47a2a] text-xl mr-2">•</span><b>Steep Terrain Navigation:</b> The climb involves negotiating a sharp summit ridge and exposed ice walls with fixed ropes. Climbers must be comfortable using jumar and descender devices on steep gradients.</li>

                                </ul>
                            </div>

                            <div className="mb-8">
                                <h2 className="text-xl sm:text-2xl  xl:text-3xl text-[#f47a2a] mb-6 mt-6">How to Prepare for the Mount Papsura Expedition? </h2>
                                ...
                                <ul>
                                    ...
                                    <li className='text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb-2'> <span className="text-[#f47a2a] text-xl mr-2">•</span>Practice using mountaineering gear such as crampons, ropes, ice axes, and ascenders. Enroll in a basic or advanced mountaineering course, or train with an alpine climbing group.
                                    </li>

                                    < li className='text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb-2'> <span className="text-[#f47a2a] text-xl mr-2">•</span>Improve your heart-lung efficiency by cycling, swimming, or jogging. This is key for performing in low-oxygen zones.</li>
                                    < li className='text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb-2'> <span className="text-[#f47a2a] text-xl mr-2">•</span>Do at least one acclimatization trek above 3,500 to 4,000 meters before the expedition. This boosts your body’s adaptation to extreme elevations.
                                    </li>

                                    < li className='text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb-2'> <span className="text-[#f47a2a] text-xl mr-2">•</span>Visualize summit conditions and practice calm breathing techniques. The summit ridge is narrow and exposed; mental control is essential during the climb.
                                    </li>

                                    < li className='text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb-2'> <span className="text-[#f47a2a] text-xl mr-2">•</span>Learn to recognize symptoms of AMS (Acute Mountain Sickness) and practice deep-breathing or pranayama exercises daily.
                                    </li>
                                    < li className='text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb-2'> <span className="text-[#f47a2a] text-xl mr-2">•</span>Get a full check-up focused on cardiovascular and respiratory health. Ensure you're cleared for sustained physical activity at high altitudes.
                                    </li>
                        ...
                        <div className="lg:w-1/3">
                            <div className="sticky top-4 z-10">
                                ...
                                <div className="mt-6 bg-white rounded-lg shadow-md p-6">
                                    ...
                                    <ul>
                                        <li className=' text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb-2'> <span className="text-[#f47a2a] text-xl mr-2">•</span><b>Location</b>: Parvati Valley, Himachal Pradesh</li>
                                        <li className='text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb-2'> <span className="text-[#f47a2a] text-xl mr-2">•</span><b>Maximum Altitude:</b>5250 meters</li>
                                        <li className='text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb-2'> <span className="text-[#f47a2a] text-xl mr-2">•</span><b>Grade:</b>Extremely Difficult and Fully Technical</li>
                                        ...
                                        <li className='text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb-2'> <span className="text-[#f47a2a] text-xl mr-2">•</span><b>Number of Days:</b>25Nights/26Days</li>
                                        ...
                                        <li className='text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb-2'> <span className="text-[#f47a2a] text-xl mr-2">•</span><b>Base Point/Starting and Ending Points:</b>Tosh Village</li>
                                    </ul>
                                </div>
