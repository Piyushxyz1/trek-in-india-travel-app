...
import { peaksDataGarhwal } from '../peaksmodalcontent';
import PeakModalContent from '../PeakModalContent';
import ClimbingTourSlider from '../ClimbingToursSlider';
  
const SwargarohiniPeak = ()=>{
 const [isOpen, setIsOpen] = useState(false);
    const openModal = () => setIsOpen(true);
    const closeModal = () => setIsOpen(false);
const [currentSlide, setCurrentSlide] = useState(0);

const peakclimbinggarhwal = activities.filter((activity)=>activity.activity === "Peak-Climbing" && activity.region === "Uttarakhand")
                ...
                <div className=' max-w-4xl md:max-w-6xl  xl:max-w-7xl  mx-auto px-4 md:px-8 '>
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div className="lg:w-2/3">
                            ...
                            <h1 className="text-xl sm:text-2xl  xl:text-4xl font-semibold text-[#172541] mt-0 mb-0 md:mb-2 lg:mb-3">Swargarohini Peak</h1>
                           ...
                           <div className="mb-8 bg-white">
                                <h3 className="text-xl font-semibold text-[#313137] mb-1">Ladakh Motorbiking:</h3>
                                <p className="mb-4 text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem]">Ladakh gives an unforgettable and breathtaking experience to the motorbike enthusiasts. The Ladakh motorbike tour does not only consist of the attractive landscapes, astounding views of the Himalayas, center of unique cultures and traditions like Buddhist Gompas; but also provides the view of the rich flora and fauna. At Trekking in India, we offer you energizing Ladakh Motorbike Tours. Mid June to Mid of October is the best time to enjoy the motorcycle riding here</p>

                            </div>

                            {/* Uttarakhand Section */}
                           <div className="mb-8 bg-white">
                                <h3 className="text-xl font-semibold text-[#313137] mb-1">Garhwal Himalayan Motorbike Tours:</h3>
                            ...
                            {/* Kumaon Section */}
                           <div className="mb-8 bg-white">
                                <h3 className="text-xl font-semibold text-[#313137] mb-1">Kumaon Motorbiking:</h3>
                                <p className="mb-4 text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem]">
                 ...
                 <PeakModalContent peaks = {peaksDataGarhwal}/>

                    </div>

                       <div className='mt-1 mb-1 sm:mt-2 md:mt-3 lg:mt-18  sm:mb-2 md:mb-3 lg:mb-4 '>
                    
                <ClimbingTourSlider TrekData={peakclimbinggarhwal} />
...
export default SwargarohiniPeak;