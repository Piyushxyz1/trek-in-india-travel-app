...
const SingaliaRidgeandGoechala = () => {
  ...
  { href: "/trekking-in-sikkim", label: "Trekking in Sikkim" },
  { label: "Singalia Ridge and Goecha La" },
];
...
`
    ...
    const images = [
       '/images/trekking-tours/sikkim/itinerary-images/singalia-ridge-goecha-la-1.webp',
        '/images/trekking-tours/sikkim/itinerary-images/singalia-ridge-goecha-la-2.webp',
       '/images/trekking-tours/sikkim/itinerary-images/singalia-ridge-goecha-la-3.webp',
       '/images/trekking-tours/sikkim/itinerary-images/singalia-ridge-goecha-la-4.webp',
      '/images/trekking-tours/sikkim/itinerary-images/singalia-ridge-goecha-la-5.webp',
      '/images/trekking-tours/sikkim/itinerary-images/singalia-ridge-goecha-la-6.webp',
    ]
        ...
        <>
            ...
            <section className='itinerary-page-section-first'>
                <div className='itinerary-page_container  max-w-4xl md:max-w-6xl  xl:max-w-7xl  mx-auto px-4 md:px-8 '>
                    ...
                    <h1 className="text-xl sm:text-2xl  xl:text-4xl font-semibold text-[#172541] mt-0 md:mt-1 mb-0 md:mb-2 xl:mb-4">Singalia Ridge and Goechala Circuit Round Trek</h1>
...
export default SingaliaRidgeandGoechala;
