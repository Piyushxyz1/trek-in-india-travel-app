...
`
  ...
  const images = [
    '/images/trekking-tours/himachal/itinerary-images/parang-la-1.webp',
    '/images/trekking-tours/himachal/itinerary-images/parang-la-2.webp',
    '/images/trekking-tours/himachal/itinerary-images/parang-la-3.webp',
    '/images/trekking-tours/himachal/itinerary-images/parang-la-4.webp',
    '/images/trekking-tours/himachal/itinerary-images/parang-la-5.webp',
    ...
    <>
      <section className='itinerary-page-section-first'>
        <div className='itinerary-page_container  max-w-4xl md:max-w-6xl  xl:max-w-7xl  mx-auto px-4 md:px-8 '>
          ...
          <h1>Parang La Trek - Kibber to Tsomoriri Parang La Trek</h1>
