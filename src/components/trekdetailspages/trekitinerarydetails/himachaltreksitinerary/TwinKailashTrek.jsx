...
{ href: "/trekking-in-himachal", label: "Trekking in Himachal" },
  ...
  const images = [
 '/images/trekking-tours/himachal/itinerary-images/shrikhand-mahadev-1.webp',
    '/images/trekking-tours/himachal/itinerary-images/shrikhand-mahadev-2.webp',
    '/images/trekking-tours/himachal/itinerary-images/shrikhand-mahadev-3.webp',
    '/images/trekking-tours/himachal/itinerary-images/shrikhand-mahadev-4.webp',
    '/images/trekking-tours/himachal/itinerary-images/shrikhand-mahadev-5.webp',
    '/images/trekking-tours/himachal/itinerary-images/kinner-kailash-1.webp',
     '/images/trekking-tours/himachal/itinerary-images/kinner-kailash-2.webp',
     '/images/trekking-tours/himachal/itinerary-images/kinner-kailash-3.webp',
  ];
...
<section className='itinerary-page-section-first'>
        <div className='itinerary-page_container  max-w-4xl md:max-w-6xl  xl:max-w-7xl  mx-auto px-4 md:px-8 '>
          ...
          <h1 className="text-xl sm:text-2xl  xl:text-4xl font-semibold text-[#172541] mt-0 md:mt-1 mb-0 md:mb-2 xl:mb-4">Twin Kailash Trek</h1>
...
export default TwinKailashTrek