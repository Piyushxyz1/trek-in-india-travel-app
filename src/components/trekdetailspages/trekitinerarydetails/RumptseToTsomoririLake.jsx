...
const RumptseToTsomoririLake = () => {
  ...
  { label: " Rumptse to Tsomoriri Lake" },
];
...
`
    ...
    const images = [
      '/images/trekking-tours/ladakh/itinerary-images/rumptse-to-tsomoriri-1.webp',
        '/images/trekking-tours/ladakh/itinerary-images/rumptse-to-tsomoriri-2.webp',
      '/images/trekking-tours/ladakh/itinerary-images/rumptse-to-tsomoriri-3.webp',
        '/images/trekking-tours/ladakh/itinerary-images/rumptse-to-tsomoriri-4.webp',
       '/images/trekking-tours/ladakh/itinerary-images/rumptse-to-tsomoriri-5.webp',
       '/images/trekking-tours/ladakh/itinerary-images/rumptse-to-tsomoriri-6.webp',
    ];
        ...
        <>
            ...
            <section className='itinerary-page-section-first'>
                <div className='itinerary-page_container  max-w-4xl md:max-w-6xl  xl:max-w-7xl  mx-auto px-4 md:px-8 '>
                    <h1 className="text-xl sm:text-2xl  xl:text-4xl font-semibold text-[#172541] mt-0 md:mt-1 mb-0 md:mb-2 xl:mb-4">Rumptse To Tsomoriri Lake</h1>
...
export default RumptseToTsomoririLake;
