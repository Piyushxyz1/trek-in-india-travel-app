...
const KalindiKhalTrek  = () => {
  ...
  { label: "Kalindi Khal Trek" },
    ...
    const images = [
        '/images/trekking-tours/garhwal/itinerary-images/kalindi-khal-1.webp',
        '/images/trekking-tours/garhwal/itinerary-images/kalindi-khal-2.webp',
        '/images/trekking-tours/garhwal/itinerary-images/kalindi-khal-3.webp',
        '/images/trekking-tours/garhwal/itinerary-images/kalindi-khal-4.webp',
        '/images/trekking-tours/garhwal/itinerary-images/kalindi-khal-5.webp',
    ];
        ...
        <>
            ...
            <section className='itinerary-page-section-first'>
                <div className='itinerary-page_container  max-w-4xl md:max-w-6xl  xl:max-w-7xl  mx-auto px-4 md:px-8 '>
                    ...
                    <h1 className="text-xl sm:text-2xl  xl:text-4xl font-semibold text-[#172541] mt-0 md:mt-1 mb-0 md:mb-2 xl:mb-4">Kalindi Khal  Trek</h1>
...
export default KalindiKhalTrek;
