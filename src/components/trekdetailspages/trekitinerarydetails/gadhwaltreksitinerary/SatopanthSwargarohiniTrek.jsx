...
const SatopanthSwargarohiniTrek = () => {
  ...
  { label: "Satopanth Lake Trek" },
    ...
    const images = [
         '/images/trekking-tours/garhwal/itinerary-images/satopanth-swargarohini-1.webp',
         '/images/trekking-tours/garhwal/itinerary-images/satopanth-swargarohini-2.webp',
         '/images/trekking-tours/garhwal/itinerary-images/satopanth-swargarohini-3.webp',
         '/images/trekking-tours/garhwal/itinerary-images/satopanth-swargarohini-4.webp',
         '/images/trekking-tours/garhwal/itinerary-images/satopanth-swargarohini-5.webp',
...
export default SatopanthSwargarohiniTrek;
