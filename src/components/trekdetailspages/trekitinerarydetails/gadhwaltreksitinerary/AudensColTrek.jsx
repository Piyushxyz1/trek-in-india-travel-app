...
const AudensColTrek = () => {
    ...
    const images = [
       '/images/trekking-tours/garhwal/itinerary-images/audens-col-1.webp',
       '/images/trekking-tours/garhwal/itinerary-images/audens-col-2.webp',
       '/images/trekking-tours/garhwal/itinerary-images/audens-col-3.webp',
       '/images/trekking-tours/garhwal/itinerary-images/audens-col-4.webp',
       '/images/trekking-tours/garhwal/itinerary-images/audens-col-5.webp',
       '/images/trekking-tours/garhwal/itinerary-images/audens-col-6.webp',
       '/images/trekking-tours/garhwal/itinerary-images/audens-col-7.webp',
        ...
        <>
            ...
            <section className='itinerary-page-section-first'>
                <div className='itinerary-page_container  max-w-4xl md:max-w-6xl  xl:max-w-7xl  mx-auto px-4 md:px-8 '>
                    ...
                    <h1 className="text-xl sm:text-2xl  xl:text-4xl font-semibold text-[#172541] mt-0 md:mt-1 mb-0 md:mb-2 xl:mb-4">Audens Col Trek</h1>
                                    ...
                                    <div className="form-cta-section modern-cta">
                                        ...
                                        <div className="form-cta-content">
                                            ...
                                            <div className="cta-actions">
                                                ...
                                                <a href="tel:+1234567890" className="secondary-cta">
                                                    CALL NOW
                                                </a>
                                            </div>
