...
const LamayurutoKanjiTrekViaPhirtseLa = () => {
...
`
    ...
    const images = [
        '/images/trekking-tours/ladakh/itinerary-images/lamayuru-kanji-1.webp',
        '/images/trekking-tours/ladakh/itinerary-images/lamayuru-kanji-2.webp',
        '/images/trekking-tours/ladakh/itinerary-images/lamayuru-kanji-3.webp',
        '/images/trekking-tours/ladakh/itinerary-images/lamayuru-kanji-4.webp',
        '/images/trekking-tours/ladakh/itinerary-images/lamayuru-kanji-5.webp',
    ];
        ...
        <>
            ...
            <section className='itinerary-page-section-first'>
                <div className='itinerary-page_container  max-w-4xl md:max-w-6xl  xl:max-w-7xl  mx-auto px-4 md:px-8 '>
                    <h1 className="text-xl sm:text-2xl  xl:text-4xl font-semibold text-[#172541] mt-0 md:mt-1 mb-0 md:mb-2 xl:mb-4">Lamayuru to Kanji Trek via Phirtse La</h1>
...
export default LamayurutoKanjiTrekViaPhirtseLa;
