...
import MostPopularMountainBikeToursPackages from "@/components/mountainbiketourpackages/MostPopularMountainBikeToursPackages";
import UttarakhandMoutainBikeTourPackages from "@/components/mountainbiketourpackages/UttarakhandMoutainBikeTourPackages";
import HimachalMountainBikeTourPackages from "@/components/mountainbiketourpackages/HimachalMountainBikeTourPackages";
import KumaonMountainBikeTourPackages from "@/components/mountainbiketourpackages/KumaonMountainBikeTourPackages";
import LadakhMoutainBikeTourPackages from "@/components/mountainbiketourpackages/LadakhMoutainBikeTourPackages";
import GarhwalMountainBikeTourPackages from "@/components/mountainbiketourpackages/GarhwalMountainBikeTourPackages";


const MountainBikeTours = () => {
  ...
  const tabs = [
    ...
    { id: "Kumaon Tours", label: "Kumaon Tours" },
    { id: "Ladakh Tours", label: "Ladakh Tours" },
  ...
  return (
    <>
      <Banner title="Mountain Bike Tours" image="/images/peak-climbing-banner.jpg" />
      ...
      <section className="w-full  max-w-4xl md:max-w-6xl  xl:max-w-7xl px-4 sm:px-6 md:px-8   mx-auto py-0 sm:py-2 lg:py-4 xl:py-10   bg-white text-center">
        ...
        <h1 className="text-xl sm:text-2xl  xl:text-4xl font-semibold text-[#172541] mt-0 mb-0 md:mb-2 lg:mb-3">
          Explore Amazing Mountain  Bike Tour Packages In India
        </h1>
        <p className="text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] text-[#313137] mb-3 md:mb-4 lg:mb-4 xl:mb-6 max-w-3xl mx-auto">
          Discover our selection of Mountain Bike Torus and other adventure activities.
        ...
        <div className="px-4 py-6 text-left">
          {activeTab === "Most Popular Tours" && <MostPopularMountainBikeToursPackages />}
          {activeTab === "Garhwal Tours" && <GarhwalMountainBikeTourPackages/>}
          {activeTab === "Himachal Tours" && <HimachalMountainBikeTourPackages />}
          {activeTab === "Uttarakhand Tours" && <UttarakhandMoutainBikeTourPackages />}
          {activeTab === "Kumaon Tours" && <KumaonMountainBikeTourPackages />}
          {activeTab === "Ladakh Tours" && <LadakhMoutainBikeTourPackages />}
...
export default MountainBikeTours;