...
const PeakPackages = () => {
  ...
  const breadcrumbPath = [
    { label: 'Peak climbing Expedition' },

  ];
  const tabs = [
    { id: "Most Popular Peaks", label: "Most Popular Peaks" },
    { id: "Garhwal Peaks", label: "Garhwal Peaks" },
    { id: "Himachal Peaks", label: "Himachal Peaks" },
    { id: "Sikkim Peaks", label: "Sikkim Peaks" },

  ];

  const [activeTab, setActiveTab] = useState("Most Popular Peaks");
  ...
  return (
    <>
      <Banner title="Peak Climbing Expedition" image="/images/peak-climbing-banner.jpg" />
      ...
      <section className="w-full  max-w-4xl md:max-w-6xl  xl:max-w-7xl px-4 sm:px-6 md:px-8   mx-auto py-0 sm:py-2 lg:py-4 xl:py-10   bg-white text-center">
        ...
        <h1 className="text-xl sm:text-2xl  xl:text-4xl font-semibold text-[#172541] mt-0 mb-0 md:mb-2 lg:mb-3">
          Explore Amazing Peak Climbing Packages In India
        </h1>
        <p className="text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] text-[#313137] mb-3 md:mb-4 lg:mb-4 xl:mb-6 max-w-3xl mx-auto">
          Discover our selection of peak climbing expeditions and other high-altitude adventure activities.
        ...
        <div className="px-4 py-6 text-left">
          {activeTab === "Most Popular Peaks" && <MostPopularPeakClimbing />}
          {activeTab === "Garhwal Peaks" && <UttrakhandPeakClimbing />}
          {activeTab === "Sikkim Peaks" && <SikkimPeakClimbing />}
          {activeTab === "Himachal Peaks" && <HimachalPeakClimbing />}
        ...
        <div className="max-w-4xl md:max-w-6xl xl:max-w-7xl mx-auto px-4 md:px-8 py-0 sm:py-2 md:py-8 xl:py-10">
          ...
          <div className="mb-10">
            <h2 className="text-xl  md:text-2xl xl:text-3xl font-semibold text-[#172541] mt-2 mb-4">
              Peak Climbing in the Indian Himalayas – A Growing Adventure Sport!
            </h2>
