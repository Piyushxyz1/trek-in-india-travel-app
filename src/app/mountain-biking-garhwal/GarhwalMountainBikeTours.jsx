...
const GarhwalMountainBikeTours = () => {
                ...
                <div className=' max-w-4xl md:max-w-6xl  xl:max-w-7xl  mx-auto px-4 md:px-8 '>
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div className="lg:w-2/3">
                            ...
                            <p className=" mt-0 text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb:0 md:mb-1 lg:mb-2 xl:mb-3">
                                The Garhwal Himalayas are built for riders chasing freedom, raw terrain, and the pulse of adventure in its purest form. Every crank of the pedal pulls you deeper into a land where the views of Trishul, Chaukhamba, Kedar Dome, and Dronagiri peaks reign the landscape, while trails weave through thick pine and oak forests, high ridgelines, and villages that have stood for centuries.
                            </p>
                            <p className=" mt-0 text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb:0 md:mb-1 lg:mb-2 xl:mb-3">
                                Garhwal mountain biking is about claiming the silence, where the only sounds are the rush of wind, the crunch of gravel, and the steady hum of your wheels. From the winding ascents out of Rishikesh to the vast blue sweep of Tehri Lake, from alpine climbs toward Chopta and the rolling meadows of Auli, every ride is a blend of grind and glide, test and triumph.
                            </p>
                            <p className=" mt-0 text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb:0 md:mb-1 lg:mb-2 xl:mb-3">
                                The routes here are as diverse as the terrain: Mussoorie’s curving hill station roads, Dhanaulti’s cedar-lined singletracks, Ghansali’s raw river-valley climbs along the Bhilangana, Chirbatia’s oak forests bursting with wildflowers, Chandrapuri’s lively village markets, Devprayag’s sacred confluence of rivers, and Haridwar’s riverside stretches along the Ganga. Each trail demands focus, rewards flow, and connects you to Garhwal’s untamed spirit.
                            </p>
                            <p className=" mt-0 text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb:0 md:mb-1 lg:mb-2 xl:mb-3">

                                Our Garhwal mountain biking tours are built for riders who thrive on steep climbs, sharp descents, and the joy of riding through landscapes that shift with every turn. You’ll push through valleys, hammer up wooded ridgelines, ride along ancient pilgrimage paths, and roll into villages where life still beats to Himalayan rhythms. Nights bring campfires, starlit skies, and stories shared with fellow riders.
...
export default GarhwalMountainBikeTours