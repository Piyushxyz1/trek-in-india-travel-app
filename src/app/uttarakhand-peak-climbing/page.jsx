...
const PeakClimbingUttarakhand = () => {
    ...
    return (
        <>
            <Banner title="Peak Climbing In Uttrakhand" image="/images/peak-climbing-tours/uttarakhand/uttarakhand-peaks-banner.webp" />
     ...
     <span className="text-[#f47a2a] font-semibold text-[0.8rem] md:[text-0.9rem] xl:text-[1rem]">Explore</span>
      <h1 className="text-xl sm:text-2xl  xl:text-4xl font-semibold text-[#172541] mt-0 mb-0 md:mb-2 lg:mb-3">
        Peak Climbing Expeditions in Uttarakhand
      </h1>
                 ...
                 <div className="w-full  max-w-4xl md:max-w-6xl  xl:max-w-7xl  px-4 py-8 mx-auto md:px-10">
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div className="lg:w-2/3">
                            ...
                            <h1 className="text-xl sm:text-2xl  xl:text-4xl font-semibold text-[#172541] mt-0 mb-0 md:mb-2 lg:mb-3">Peak Climbing in Uttrakhand Himalayas - A Growing Adventure Sport!</h1>
...
export default PeakClimbingUttarakhand;