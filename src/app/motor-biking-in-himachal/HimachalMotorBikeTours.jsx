...
const HimachalMotorBikeTours = () => {
    ...
    const activitiesData = activities.filter(activity => activity.activity === "Motor-Biking" && activity.region === "Himachal")
    return (
        <>
            ...
            <section className='packages px-4 sm:px-6 lg:px-8'>
                <div className='w-full  max-w-4xl md:max-w-6xl  xl:max-w-7xl  px-4 py-8 mx-auto md:px-10'>
                    <h1 className="text-xl sm:text-2xl  xl:text-4xl font-semibold text-[#172541] mt-0 mb-0 md:mb-2 lg:mb-3">Motor Bike Tours In Himachal</h1>
                ...
                <div className=' max-w-4xl md:max-w-6xl  xl:max-w-7xl  mx-auto px-4 md:px-8 '>
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div className="lg:w-2/3">
                            ...
                            <h1 className="text-xl sm:text-2xl  xl:text-4xl font-semibold text-[#172541] mt-0 mb-0 md:mb-2 lg:mb-3">Motorbiking in Himachal</h1>
                            <p className=" mt-0 text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb:0 md:mb-1 lg:mb-2 xl:mb-3">
                                Rugged roads. Roaring engines. Adventure on mind—motorbiking in Himachal is the adventure you’ve been waiting for. Every twist of the throttle here takes you through shifting landscapes, from pine-clad valleys to rugged high-altitude deserts, making the journey as exhilarating as the destination. Motorbiking expeditions in Himachal Pradesh are for riders who crave the perfect balance of raw adventure and mountain serenity. The adventure calls with legendary passes like Baralacha La and Kunzum, dirt roads, hairpin bends, and thin mountain air that push both man and machine to their limits.
                            </p>
                            <p className=" mt-0 text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb:0 md:mb-1 lg:mb-2 xl:mb-3">
                                The biking trails in Himachal Pradesh lead you into the stark wilderness of Spiti Valley, a place where barren cliffs and ancient monasteries whisper stories of survival and spirituality. The adventure of motorbiking in Spiti Valley is something else; the rides are intense, challenging, and awe-inspiring. Roaring engines echo against towering peaks until you reach icons like Key Monastery, standing guard above the Spiti River, or Dhankar Monastery, clinging dramatically to its cliffside. The adventure intensifies at high altitudes like Chandra Tal (Moon Lake), where the dirt roads and rugged paths test your skills, strength, and courage, for these roads are certainly not for the faint-hearted.
                            ...
                            <p className=" mt-0 text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb:0 md:mb-1 lg:mb-2 xl:mb-3">
                               ...
                               Motorbiking in Himachal Pradesh between 1500 and 2500 m is also distinctive, as the terrain is decked with green valleys, orchards, and traditional wooden homes. The motorbiking expedition in this part of Himachal is a reminder that every punishing ascent and bone-rattling stretch rewards you with moments of pure serenity. From the glacier-fed torrents of the Beas to the ancient marvel of Masroor Temple, biking expeditions in this region of Himachal unfold like an epic for bikers, each chapter written in dust, sweat, and freedom. 

 
                            </p>
                            <p className=" mt-0 text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb:0 md:mb-1 lg:mb-2 xl:mb-3">

                                So, gear up and embrace the Himachal motorbike adventure, a ride where the roads test your grit, the mountains humble your spirit, and the freedom of the open road leaves you craving more. 
...
export default HimachalMotorBikeTours