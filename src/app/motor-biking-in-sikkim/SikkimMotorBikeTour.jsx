...
const SikkimMotorBikeTour = () => {
    ...
    const activitiesData = activities.filter(activity => activity.activity === "Motor-Biking" && activity.region === "Sikkim")
    return (
        <>
            ...
            <section className='packages px-4 sm:px-6 lg:px-8'>
                <div className='w-full  max-w-4xl md:max-w-6xl  xl:max-w-7xl  px-4 py-8 mx-auto md:px-10'>
                    <h1 className="text-xl sm:text-2xl  xl:text-4xl font-semibold text-[#172541] mt-0 mb-0 md:mb-2 lg:mb-3">Motor Bike Tours In Sikkim</h1>
                ...
                <div className=' max-w-4xl md:max-w-6xl  xl:max-w-7xl  mx-auto px-4 md:px-8 '>
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div className="lg:w-2/3">
                            ...
                            <h1 className="text-xl sm:text-2xl  xl:text-4xl font-semibold text-[#172541] mt-0 mb-0 md:mb-2 lg:mb-3">Motorbiking in Sikkim</h1>
                            <p className=" mt-0 text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb:0 md:mb-1 lg:mb-2 xl:mb-3">
                                A Sikkim motorbike expedition is pure Himalayan adventure, where every curve in the road reveals a new side of the mountains. The ride takes you across winding alpine trails bursting with wildflowers, through dense forests that echo with bird calls, and along the roaring rivers like the Teesta and Rangit, which carve deep valleys. High-altitude lakes such as Tsomgo and Khecheopalri shimmer like mirrors, while the snow-clad guardian of the region, Mt. Khangchendzonga (8,586 m), towers above, guiding every mile of the journey
                            </p>
                            <p className=" mt-0 text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb:0 md:mb-1 lg:mb-2 xl:mb-3">
                                What makes biking in Sikkim special isn’t just the raw terrain but also the rhythm of life along the route. Villages perched on terraced hillsides like Lachung and Rinchenpong welcome riders with prayer flags fluttering in the wind, monastery bells echoing across valleys, and the warmth of Sikkimese hospitality. The mix of Lepcha, Bhutia, and Nepali traditions adds a cultural depth that makes every stop on the ride more than just a pause.
                            </p>
                            <p className=" mt-0 text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb:0 md:mb-1 lg:mb-2 xl:mb-3">


                                The road challenges bike riders with steep ascents, sharp hairpin bends, and sudden shifts in altitude that test both skill and endurance. Yet, in between the thrill, moments of calm emerge: a reflective halt at Gurudongmar Lake, one of the highest motorable lakes in the world; a refreshing break at waterfalls like Seven Sisters or Naga; or a soak in Reshi’s natural hot springs to ease the day’s fatigue. Many of the biking trails in Sikkim extend into Darjeeling, where sweeping tea gardens and the legendary sunrise from Tiger Hill add a final flourish to the ride.
                            </p>
                            <p className=" mt-0 text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb:0 md:mb-1 lg:mb-2 xl:mb-3">


                                In Sikkim, every kilometre on a motorbike is alive with contrasts, adventure, challenge, reward, and grit and grace. Riding through the Eastern Himalayas is a journey that fuses man, machine, and mountain into one unforgettable biking experience.
...
export default SikkimMotorBikeTour