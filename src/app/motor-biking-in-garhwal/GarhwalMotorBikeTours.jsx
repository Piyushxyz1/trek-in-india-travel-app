...
const GarhwalMotorBikeTours = () => {
    ...
    const activitiesData = activities.filter(activity => activity.activity === "Motor-Biking" && activity.region === "Garhwal")
    return (
        <>
            ...
            <section className='packages px-4 sm:px-6 lg:px-8'>
                <div className='w-full  max-w-4xl md:max-w-6xl  xl:max-w-7xl  px-4 py-8 mx-auto md:px-10'>
                    <h1 className="text-xl sm:text-2xl  xl:text-4xl font-semibold text-[#172541] mt-0 mb-0 md:mb-2 lg:mb-3">Motor Bike Tours In Garhwal</h1>
                ...
                <div className=' max-w-4xl md:max-w-6xl  xl:max-w-7xl  mx-auto px-4 md:px-8 '>
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div className="lg:w-2/3">
                            ...
                            <h1 className="text-xl sm:text-2xl  xl:text-4xl font-semibold text-[#172541] mt-0 mb-0 md:mb-2 lg:mb-3">Motorbiking in Garhwal </h1>
                            <p className=" mt-0 text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb:0 md:mb-1 lg:mb-2 xl:mb-3">
                                Get ready for a motorbiking adventure in Garhwal, a journey that takes you through the river valleys, meandering roads, and rugged Himalayan switchbacks. On a Garhwal motorbike tour, the road itself becomes the pilgrimage. You’ll ride beside the rivers, cross remote high-altitude hamlets, and pause in timeless villages where Garhwali traditions still thrive. Each curve carries you closer not just to the Himalayas but to a culture deeply rooted in faith and mountain life.
                            </p>
                            <p className=" mt-0 text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb:0 md:mb-1 lg:mb-2 xl:mb-3">
                                Kickstart your motorbiking tour in Garhwal from Rishikesh, where the engine’s hum merges with the roar of the Ganges below. Then it powers upward to Devprayag, where the Alaknanda and Bhagirathi rivers come together to form the sacred Ganges. From there, the roads lead you through Srinagar (Garhwal), on to the hill town of Mussoorie, and into the alpine meadows of Chopta. Every mile unfolds a new backdrop: pine-scented forests, terraced fields clinging to mountain slopes, and towering peaks like Chaukhamba, Kedarnath Dome, and Trishul watching over the route.
                            </p>
                            <p className=" mt-0 text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb:0 md:mb-1 lg:mb-2 xl:mb-3">
                                For bikers, the charm of motorbiking in Garhwal lies in its balance of long stretches, some well-paved and some dirt roads. One moment you’re leaning hard into hairpin bends carved out of cliffs, and the next you are in a remote temple town. Extensions make the ride even more rewarding, towards Kedarnath via Guptkashi or to Badrinath through Joshimath, where the skyline is dominated by Nanda Devi and Hathi Parbat. And for those chasing altitude, the road to Nelong Valley is also now accessible by motorbike.
                            </p>
                            <p className=" mt-0 text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb:0 md:mb-1 lg:mb-2 xl:mb-3">

                                For riders with time and grit, the roads push higher towards Mana, the last Indian village before Tibet, or across rugged passes linking Garhwal to Kumaon. Here, the adventure intensifies with dizzying altitude, endless curves, and views that demand a stop no matter how smooth your throttle hand.
...
export default GarhwalMotorBikeTours