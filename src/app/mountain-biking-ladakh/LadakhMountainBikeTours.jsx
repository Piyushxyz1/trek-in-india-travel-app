...
const LadakhMountainBikeTours = () => {
    ...
    const activitiesData = activities.filter(activity => activity.activity === "Mountain-Biking" && activity.region === "Ladakh")
    return (
        <>
                ...
                <div className=' max-w-4xl md:max-w-6xl  xl:max-w-7xl  mx-auto px-4 md:px-8 '>
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div className="lg:w-2/3">
                            ...
                            <h1 className="text-xl sm:text-2xl  xl:text-4xl font-semibold text-[#172541] mt-0 mb-0 md:mb-2 lg:mb-3">Motorbiking in Ladakh </h1>
                            <p className=" mt-0 text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb:0 md:mb-1 lg:mb-2 xl:mb-3">
                            ...
                            <p className=" mt-0 text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb:0 md:mb-1 lg:mb-2 xl:mb-3">
                                Our Ladakh mountain biking tours are built for riders who want altitude, grit, and raw adventure. With expert support, mechanical backup, and flexible routes, riders can push into less-traveled terrain like Zanskar’s rugged passes or Umling La, the highest motorable pass in the world. 
                            </p>
                            <p className=" mt-0 text-[#313137] text-[0.8rem] sm:text-[0.8rem] md:text-[0.9rem] xl:text-[1rem] mb:0 md:mb-1 lg:mb-2 xl:mb-3">

                                So push through high-altitude ascents, carve down hairpin descents, or spin through valleys at golden sunset; mountain biking in Ladakh will connect you to the wild, the culture, and the quiet power of the Himalayas like nowhere else on Earth. 
...
export default LadakhMountainBikeTours