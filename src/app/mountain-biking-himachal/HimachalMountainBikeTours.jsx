...
const HimachalMountainBikeTours = () => {
    ...
    const activitiesData = activities.filter(activity => activity.activity === "Mountain-Biking" && activity.region === "Himachal")
    return (
        <>
            ...
            <section className='packages px-4 sm:px-6 lg:px-8'>
                <div className='w-full  max-w-4xl md:max-w-6xl  xl:max-w-7xl  px-4 py-8 mx-auto md:px-10'>
                    <h1 className="text-xl sm:text-2xl  xl:text-4xl font-semibold text-[#172541] mt-0 mb-0 md:mb-2 lg:mb-3">Mountain Bike Tours In Himachal</h1>
...
export default HimachalMountainBikeTours